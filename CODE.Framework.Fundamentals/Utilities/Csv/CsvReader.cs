...
namespace CODE.Framework.Fundamentals.Utilities.Csv
{
    ...
    public partial class CsvReader : IDataReader, IEnumerable<string[]>
    {
        ...
        ///	The instance has been disposed of.
        /// </exception>
        public bool ReadNextRecord() => ReadNextRecord(false, false);
        ...
        DataTable IDataReader.GetSchemaTable()
        {
            ...
            var schema = new DataTable("SchemaTable") {Locale = CultureInfo.InvariantCulture, MinimumCapacity = _fieldCount};
        ...
        ///	The instance has been disposed of.
        /// </exception>
        public RecordEnumerator GetEnumerator() => new RecordEnumerator(this);
