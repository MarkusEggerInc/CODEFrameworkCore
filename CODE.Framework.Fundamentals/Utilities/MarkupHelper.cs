...
namespace CODE.Framework.Fundamentals.Utilities
{
    namespace CODE.Framework.Core.Utilities
    {
        ...
        public static class MarkupHelper
        {
            ...
            /// This is some text
            /// </example>
            public static string StripMarkup(string markup) => Regex.Replace(markup, @"<(.|\n)*?>", string.Empty);
            ...
            /// displayed as a portion of a larger HTML output.
            /// </remarks>
            public static string GetStrippedBodyOnly(string html) => StripMarkup(GetBodyOnly(html));
            ...
            public static string GetRssFormattedDateTime(DateTime date)
            {
                ...
                var month = date.ToLongDateString();
            ...
            /// </example>
            public static string ToRssData(DateTime date) => GetRssFormattedDateTime(date);
            ...
            public static string XmlEncode(string text) => SimpleHtmlEncode(text);

            /// <summary>HTML-encodes a string and returns the encoded string.</summary>
            /// <param name="text">The text string to encode. </param>
            /// <returns>The HTML-encoded text.</returns>
            public static string SimpleHtmlEncode(string text)
            {
            ...
            public static string PlainTextToHtml(string text)
            {
                ...
                {
                    sb.Append(SimpleHtmlEncode(line.Trim()));
